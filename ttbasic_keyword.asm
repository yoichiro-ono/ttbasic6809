...
I_DIV	EQU	(*-KW_TO_ICODE_TBL)/3+I_CODE_MIN
	FDB	KW_DIV
	FCB	I_DIV
I_COMPARE_START	EQU	(*-KW_TO_ICODE_TBL)/3+I_CODE_MIN
...
I_SHARP	EQU	(*-KW_TO_ICODE_TBL)/3+I_CODE_MIN
	FDB	KW_SHARP
	FCB	I_SHARP
I_LE	EQU	(*-KW_TO_ICODE_TBL)/3+I_CODE_MIN
	FDB	KW_LTE
	FCB	I_LE
I_LT	EQU	(*-KW_TO_ICODE_TBL)/3+I_CODE_MIN
	FDB	KW_LT
	FCB	I_LT
I_GE	EQU	(*-KW_TO_ICODE_TBL)/3+I_CODE_MIN
	FDB	KW_GTE
	FCB	I_GE
I_COMPARE_END	EQU	(*-KW_TO_ICODE_TBL)/3+I_CODE_MIN
